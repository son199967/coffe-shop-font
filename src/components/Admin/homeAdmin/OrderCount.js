...
class OrderCount extends Component {
  ...
  componentDidMount() {
    if (
      ...
      localStorage.getItem(ACCESS_TOKEN_NAME) === null ||
      localStorage.getItem(ACCESS_TOKEN_NAME) === undefined ||
      localStorage.getItem(ACCESS_TOKEN_NAME) === "undefined"
    ) {
  ...
  thanhToanDon = async () => {
    const hoaDon = await axios
      .get(API_BASE_URL + `/thanhtoanDon?id=${this.state.hoaDon.id}`, {})
      .then(function (response) {
        if (response.status === 200) {
          console.log("hoadon", response.data);
      ...
      (s, index) => (
        <div className="tm-popular-item col-4" key={index}>
          ...
          <div className="tm-popular-item-description">
            ...
            <div className="tm-handwriting-font caption">
            ...
            <div style={{ width: "100%", height: "20px" }}>
              <input
                ...
                onClick={() => this.addSpToCartIteim(s)}
                value="Add To Cart"
              />
            </div>
          </div>
          ...
          <div className="row m-2">
            ...
            <div className="col-2">
              ...
              <button
                ...
                onClick={() => this.deleteSpToCart(this.state.hoaDon.id, s.id)}
              >
    ...
    return (
      <div className="row m-5" style={{ "font-size": "15px" }}>
        <div className="col-8 border">
          <div className="row">{loaiSp}</div>
          <div className="row mt-5">{sanPhamLoai}</div>
        </div>
          ...
          <form className="form-row">
            <div class="form-group col-lg-12">
              ...
              <input
                ...
                onChange={(e) => this.handleChangeObjKH(e, "tenKh")}
            ...
            <div class="form-group col-lg-12">
              ...
              <input
                type="text"
                class="form-control"
                value={this.state.khachHang.email}
                onChange={(e) => this.handleChangeObjKH(e, "email")}
                placeholder="Email"
              />
            </div>
            <div class="form-group col-lg-8">
              <form class="form-inline">
                ...
                <input
                  ...
                  value={this.state.khachHang.sdt}
                  onChange={(e) => this.handleChangeObjKH(e, "sdt")}
                  placeholder="Phone"
                />
                <input
                  type="button"
                  className="p-1 ml-1 btn-secondary"
                  value="Search"
                  onClick={() => this.findSdtKhachHang()}
                />
              </form>
            </div>
